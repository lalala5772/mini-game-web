<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	...
	<section class="all-games-section">
		...
		<div class="games-grid">
			<a href="/rhythmGame.games" class="game-link">
			<div class="game-card">
			...
			<a href="/crossRoad.games" class="game-link">
			<div class="game-card">
			...
			<a href="/barbecue.games" class="game-link">
			<div class="game-card">
			...
			<a href="/chamchamcham.games" class="game-link">
			<div class="game-card">
			...
			<a href="/zombieCrusher.games" class="game-link">
			<div class="game-card">
			...
			<a href="/snakeGame.games" class="game-link">
			<div class="game-card">
